...
function show_help(node, name) {
  ...
  console.log("  title=<title>: title of the component");
  console.log("  view=<ns>:     namespace for the view (none, html, or svg)");
  console.log("");
  process.exit(0);
}

var args = get_args(process.argv.slice(2), { view: "html" });
if (args.help) {
...
var title = args.title ? flexo.xml_tag("title", args.title) : "";
console.log(flexo.xml_tag("component", { xmlns: bender.ns, href: args.href,
  id: args.id }, title, view));
